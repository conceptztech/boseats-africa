...
<body>
    ...
    <div class="container">
        ...
        <div class="search-section">
            <div class="search-title">Hotel Apartment for you</div>
        ...
        <div class="card-container">
            <!-- Card 1 -->
            <div class="card">
                <img src="../assets/images/concert1.png" alt="Stand Tall Concert">
                <div class="card-body">
            ...
            <!-- Card 2 -->
            <div class="card">
                <img src="../assets/images/concert2.png" alt="Stand Tall Concert">
                <div class="card-body">
                    <h3>Stand Tall Concert</h3>
                    <p class="card-owner">Owner - Divido . Seat - Regular</p>
            ...
            <!-- Card 3 -->
            <div class="card">
                <img src="../assets/images/concert3.png" alt="The Summer Concert">
                <div class="card-body">
                   ...
                   <a style="text-decoration:none; color: white;"href="event-details.php"> <button class="buy-button">Buy tickets</button></a>
                        ...
                        <!-- Card 3 -->
            <div class="card">
                <img src="../assets/images/concert4.png" alt="The Summer Concert">
                <div class="card-body">
                    <h3>The Summer Concert</h3>
                    <p class="card-owner">Owner - RockFest . Seat - Regular</p>
            ...
            <!-- Card 4 -->
            <div class="card">
                <img src="../assets/images/event4.jpg" alt="Fun Zone">
                <div class="card-body">
                    <h3>Fun Zone</h3>
